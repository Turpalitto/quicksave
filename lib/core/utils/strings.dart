...
class Strings {
  ...
  String get historyFailedBadge =>
      _s((l) => l.historyFailedBadge, 'Ошибка');
  ...
  String get semHomeHistory =>
      _s((l) => l.semHomeHistory, 'Открыть историю');
